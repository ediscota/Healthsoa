...
INSERT INTO `test_order` (`id`, `patient_id`, `exam_code`, `status`, `callback_url`, `created_at`, `updated_at`)
VALUES (1, '1', 'PANEL_RENAL', 'COMPLETED', NULL, '2026-06-01 08:00:00', '2026-06-01 08:08:00');

INSERT INTO `measurement` (`order_id`, `parameter`, `value`, `unit`, `reference_range`, `anomaly_flag`)
VALUES
