INSERT INTO `patient` (`fiscal_code`, `first_name`, `last_name`, `date_of_birth`, `gender`, `phone`) VALUES
...
INSERT INTO `condition_entry` (`patient_id`, `icd10_code`, `description`, `onset_date`, `status`) VALUES
...
INSERT INTO `allergy` (`patient_id`, `substance`, `reaction_severity`, `detected_date`) VALUES
